...
const link = { "media-url": "https://raw.githubusercontent.com/Koolson/Qure/master/IconSet/Color/Streaming.png" } 
...
!(async () => {
  ...
  .then((code) => {
    ...
    $notify(result["title"], result["subtitle"], result["content"], link)
